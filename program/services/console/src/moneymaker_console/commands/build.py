...
def register(registry: CommandRegistry) -> None:
    ...
    registry.register(
        "build", "ingestion", _build_ingestion, "Build Data Ingestion image", timeout_sec=300
    )
    registry.register("build", "bridge", _build_bridge, "Build MT5 Bridge image", timeout_sec=300)
    registry.register(
        "build", "dashboard", _build_dashboard, "Build Dashboard image", timeout_sec=300
    )
    registry.register(
        "build", "external", _build_external, "Build External Data image", timeout_sec=300
    )
    registry.register(
        "build", "test-only", _build_test_only, "Run tests without building", timeout_sec=300
    )
    registry.register(
        "build", "proto", _build_proto, "Recompile protobuf definitions", timeout_sec=120
    )
